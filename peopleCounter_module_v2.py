...
# Variáveis de Controle:
                                                                # Define se será utilizado as configurações
useConfigFile = True                                            # padrões ou manuais (parametersConfiguration.py) 
                                                                
line_aligment = 'horizontal'									# Define o alinhamento da linha de passagem
log_init = False                                                # Define se será feito log ou não
